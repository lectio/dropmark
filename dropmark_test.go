...
func (suite *DropmarkSuite) TestDropmarkCollection() {
	...
	suite.Equal(item.Title(), "Signify Research HIMSS 2019 Show Report (PDF)")
	suite.Nil(item.Errors(), "There should be no errors at the item level")
}
